...
func TestDemote_ActiveNodeGoesProvisioning(t *testing.T) {
	...
	seedActive(t, nodes, `{"id":"dn-1","role":"entry","status":"active","provider":"l","cloud":"l","region":"eu","entry_ip":"1.1.1.1","ephemeral_entry_ip":false,"transports":[`+vlessTr+`]}`)
...
func TestDemote_RejectsTerminalStates(t *testing.T) {
	...
	seedActive(t, nodes, `{"id":"dn-2","role":"entry","status":"active","provider":"l","cloud":"l","region":"eu","entry_ip":"1.1.1.2","ephemeral_entry_ip":false,"transports":[`+vlessTr+`]}`)
	...
	seedActive(t, nodes, `{"id":"dn-3","role":"entry","status":"active","provider":"l","cloud":"l","region":"eu","entry_ip":"1.1.1.3","ephemeral_entry_ip":false,"transports":[`+vlessTr+`]}`)
...
func TestDemote_RBAC(t *testing.T) {
	r, nodes := newTestRouterWithNodes(t)
	seedActive(t, nodes, `{"id":"dn-4","role":"entry","status":"active","provider":"l","cloud":"l","region":"eu","entry_ip":"1.1.1.4","ephemeral_entry_ip":false,"transports":[`+vlessTr+`]}`)
