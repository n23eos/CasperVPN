...
Перед работой также прочитай `CLAUDE.md`. В нём находятся более свежие сведения
о составе workspace, версиях Go и обязательных проверках; по этим вопросам он
имеет приоритет. Этот файл сохраняет силу для остальных правил репозитория.
